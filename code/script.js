...
const pesq = document.querySelector('#search');
const cida = document.getElementById('input');
const cidade = document.getElementById('cidade');
const ocasi = document.querySelector('#ocasi');
...
const bt = document.querySelector('#mais');
...
const btnn = document.querySelector('#Vento');
const cara0 = document.querySelector('#cara0');
